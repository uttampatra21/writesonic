            ...
            <div class="-mx-4 flex flex-wrap justify-between">
              <div class="px-4 my-4 w-full xl:w-1/5">
                ...
                <p class="text-justify">
                  At WS you get the best of best working services which will
                  never let you or your clients down. We always try to give best
                  services in the market which is always working.
                </p>
              </div>
          ...
          <div class="container mx-auto px-4">
            <div class="-mx-4 flex flex-wrap justify-between">
              <div class="px-4 w-full text-center sm:w-auto sm:text-left">
                ...
                - 2022 Writesonic. All Rights Reserved.
              </div>
              <div class="px-4 w-full text-center sm:w-auto sm:text-left">
                Made with ❤️ by{" "}
                <img
